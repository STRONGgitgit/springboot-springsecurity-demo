...
<div id="content">
	...
	<form class="form-inline">
			<security:authorize buttonUrl="/resources/addResources,POST"><%-- <security:authorize buttonUrl="/role/addRole.do">--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#datatable').DataTable( {
            ...
            "ajax": '${ss}/resources/resourcesList',
            "columns": [
                { "data": "id" },
                { "data": "name" },
                { "data": "resKey" },
            ...
            columnDefs:[{
                ...
                render: function (data, type, row, meta) {
                    return '<p><security:authorize buttonUrl='/resources/delResources/*,DELETE'><a type="button" class="btn btn-danger  btn-default" href="javascrip:;" onclick=delById(' + row.id + ') >删除</a></security:authorize>'+
                        '<security:authorize buttonUrl='/role/editResources,PUT'><a type="button" class="btn btn-success btn-default" href="javascrip:;" onclick=allotResources(' + row.id + ') >修改</a></security:authorize></p>';
                    <%--<security:authorize buttonUrl='/role/editResources.do'>--%>
                }
            },
    ...
    function delById(id) {
        layer.confirm('您确定要删除该资源吗？', {
            ...
            $.ajax({
                cache: true,
                type: "POST",
                url:'${ss}/resources/delResources/'+id,
                /*data:{id:id},*/
                data:{"_method":"DELETE"},
                async: false,
                dataType:"text",
